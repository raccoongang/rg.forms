...
EXAMPLES = [
    ...
    },
    {
        ...
        "subtitle": "A real edit/CRUD workflow",
        "blurb": "Pre-filled from the store, input preserved on error, a server permission-gated field.",
        "tags": ["CRUD", "ADR-0004", "permissions"],
        "url": "examples:account_edit",
    },
    {
        "title": "Multi-step wizard",
        "subtitle": "Server-held state between steps",
        "blurb": "3 steps, validate-before-advance, conditional step skip, back nav — no client engine.",
        "tags": ["wizard", "session", "server-driven"],
        "url": "examples:wizard",
    },
    {
        "title": "Tampering lab",
        "subtitle": "“The server decides”, made tangible",
        "blurb": "Crafted hostile submissions and their authoritative outcomes (total, scope, external signal, hidden).",
        "tags": ["security", "server-authoritative"],
        "url": "examples:tampering_lab",
    },
    {
        "title": "Form-level errors",
        "subtitle": "Rules that span fields",
        "blurb": "Ordered date range + a budget split that must total 100% — non-field errors on submit.",
        "tags": ["ADR-0004", "non-field errors"],
        "url": "examples:form_errors",
    },
    {
        "title": "Date / time & localization",
        "subtitle": "Temporal canonical values",
        "blurb": "Canonical date/time/datetime strings, lossless round-trip, server validation.",
        "tags": ["ADR-0002", "date/time"],
        "url": "examples:datetime_localization",
    },
    {
        "title": "Widget gallery",
        "subtitle": "First-class vs. fallback widgets",
        "blurb": "radio, multi-checkbox, file, date, textarea — reactive widgets vs. correct Django fallback.",
        "tags": ["ADR-0001", "widgets"],
        "url": "examples:widget_gallery",
    },
    {
        "title": "Cascading dropdowns",
        "subtitle": "Country → region → city (retained)",
        "blurb": "choices_from + depends_on, server re-render, pending indicator, invalid-child reset.",
